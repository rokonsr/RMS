...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="tablepadding">
        <tr>
            ...
            <td>
                <asp:RadioButtonList ID="rdItemDetailList" runat="server" CssClass="space" AutoPostBack="True"  RepeatDirection="Horizontal"  OnSelectedIndexChanged="rdItemDetailList_OnSelectedIndexChanged">
