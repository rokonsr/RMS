...
namespace RMS.BLL
{
    public class SaleBiz
    {
        ...
        public bool SellProduct(Sale objSale)
        {
            ...
            objDbCommand.AddInParameter("VatAmountTotal", objSale.VatAmountTotal);
            ...
            objDbCommand.AddInParameter("Vat", objSale.Vat);
            objDbCommand.AddInParameter("VatAmount", objSale.VatAmount);
            ...
            try
            {
                ...
                if (objDbDataReader.HasRows)
                {
                    while (objDbDataReader.Read())
                    {
                        ...
                        objCustomer.CustomerTotalDue = Convert.ToDecimal(objDbDataReader["CustomerTotalDue"]);
