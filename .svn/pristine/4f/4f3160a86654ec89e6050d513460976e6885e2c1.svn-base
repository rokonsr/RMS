...
$(function () {
   ...
   // Enamul
    ...
    $('#txtProductCode').autocomplete({
        ...
        change: function () {
            $.ajax({
                url: "../WebServices/AutoCompleteService.asmx/GetProductDetailForSale",
                data: "{'productCode': '" + this.value + "' }",
                type: "POST",
                dataType: "json",
                contentType: "application/json;charset=utf-8",
                success: function (data) {
                    $('#txtProductName').val(data.d.ProductName);
                    $('#txtProductStock').val(data.d.ProductStock.toFixed(2));
                    $('#txtProductPricePerUnit').val(data.d.ProductSellPrice.toFixed(2));
                    $('#txtVat').val(data.d.Vat.toFixed(2));
                },
                error: function (result) {
                    alert('Not Match');
                }
    ...
    $('#txtCustomerUsername').autocomplete({
        ...
        change: function () {
            $.ajax({
                url: "../WebServices/AutoCompleteService.asmx/GetCustomerDetailForSale",
                data: "{'customerName': '" + this.value + "' }",
                type: "POST",
                dataType: "json",
                contentType: "application/json;charset=utf-8",
                success: function (data) {
                    $('#txtCustomerFullName').val(data.d.CustomerFullName);
                    $('#txtCustomerContactNo').val(data.d.CustomerContactNumber);
                    $('#txtCustomerDue').val(data.d.CustomerTotalDue.toFixed(2));
                    totalValueWithDue();
                },
                error: function (result) {
                    alert('Not Match');
